...
const uint8_t keymap_skooldaze[] = {
    // Extended key maps must be the initial entries.
    KEY_DOWN|KEY_EXT, KEY_LEFT, 'f', // Down + left = fire catapult
...
// Pac-Man
const uint8_t keymap_pacman[] = {
    KEY_LEFT, 0, 'o',           // o: left
    KEY_RIGHT, 0, 'p',          // p: iright
    KEY_FIRE, 0, 's',           // s: starts the game.
    KEY_DOWN, 0, 'a',           // a: down
    KEY_UP, 0, 'q',             // q: up
    KEY_END, 0, 0,
};
